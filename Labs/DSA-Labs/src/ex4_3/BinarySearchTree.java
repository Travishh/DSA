   ...
   implements SortedSet<E>
{
   ...
   //left rotation of root
    public void leftRotationOfRoot(){
       BinaryTreeNode temp = rootNode.rightChild.leftChild;
       rootNode.rightChild.leftChild = null;
       BinaryTreeNode newRoot = rootNode.rightChild;
     ...
     public void rightRotationOfRoot(){
       BinaryTreeNode temp = rootNode.leftChild.rightChild;
       rootNode.leftChild.rightChild = null;
       BinaryTreeNode newRoot = rootNode.leftChild;
   ...
   {  // create the binary search tree
      ...
      System.out.println("\nPerforming LEFT rotation of root");
      tree.leftRotationOfRoot();
      System.out.println(tree);
      
      System.out.println("\nPerforming RIGHT rotation of root.(Back to Orignal Tree)");
