...
public class JourneyPlannerTest {
    ...
    {   System.out.println("------ JOURNEY PLANNER -----");
        ...
        buildGraphSimple(planner);
        
        List<BusJourney> options = planner.getPossibleJourneys("Auckland CBD", LocalTime.of(6, 0), "New Lynn", LocalTime.of(15,0));
        
        //YOU NEED TO WRITE a SUITABLE  "JouneyComparator"
        //Collections.sort(options, new JourneyComparator());
           
        System.out.println(">>>  There are "+options.size()+" possible journeys for your search from Auckland CBD ("+LocalTime.of(6,0) + ") to New Lynn (" + LocalTime.of(15, 0) + ")");
        for(int i=0;i<options.size();i++)
        {   System.out.println("Journey Option "+(i+1)+": "+options.get(i));
        }
    }
    
    public static void buildGraphSimple(JourneyPlanner planner){
        
         // AUCKLAND CBD to MT ALBERT
        LocalTime departTime = LocalTime.of(6, 0);
        LocalTime arriveTime = LocalTime.of(6,30);
        planner.add(new BusTrip("22N", "Auckland CBD", departTime, "Mt Albert", arriveTime, BusTrip.TWO_STAGE));              
        planner.add(new BusTrip("22N", "Mt Albert", departTime, "Auckland CBD", arriveTime, BusTrip.TWO_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);

        planner.add(new BusTrip("23N", "Auckland CBD", departTime, "Mt Albert", arriveTime, BusTrip.TWO_STAGE));
        planner.add(new BusTrip("23N", "Mt Albert", departTime, "Auckland CBD", arriveTime, BusTrip.TWO_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);

        //MT Albert to NewLynn
        departTime = LocalTime.of(7, 0);
        arriveTime = LocalTime.of(7,25);
        planner.add(new BusTrip("23M", "Mt Albert", departTime, "New Lynn", arriveTime, BusTrip.TWO_STAGE));
        ...
        planner.add(new BusTrip("21K", "Kingsland", departTime, "Auckland CBD", arriveTime, BusTrip.ONE_STAGE));
        planner.add(new BusTrip("21K", "Auckland CBD", departTime, "Kingsland", arriveTime, BusTrip.ONE_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);
        planner.add(new BusTrip("22K", "Kingsland", departTime, "Auckland CBD", arriveTime, BusTrip.ONE_STAGE));
        planner.add(new BusTrip("22K", "Auckland CBD", departTime, "Kingsland", arriveTime, BusTrip.ONE_STAGE));
        
        //New Lynn to Henderson
        departTime = LocalTime.of(7, 0);
        arriveTime = LocalTime.of(7,30);
        planner.add(new BusTrip("12H", "New Lynn", departTime, "Henderson", arriveTime, BusTrip.TWO_STAGE));
        departTime = departTime.plusMinutes(30);
        arriveTime = arriveTime.plusMinutes(30);
        planner.add(new BusTrip("12H", "Henderson", departTime, "New Lynn", arriveTime, BusTrip.TWO_STAGE));
        
         //Henderson to Waitakere
        departTime = LocalTime.of(6, 0);
        arriveTime = LocalTime.of(6,40);
        planner.add(new BusTrip("34W", "Waitakere", departTime, "Henderson", arriveTime, BusTrip.FOUR_STAGE));
        planner.add(new BusTrip("34W", "Henderson", departTime, "Waitakere", arriveTime, BusTrip.FOUR_STAGE));
        
        //New Lyn to Waitakere
        departTime = LocalTime.of(6, 0);
        arriveTime = LocalTime.of(7,0);
        planner.add(new BusTrip("76W", "Waitakere", departTime, "New Lynn", arriveTime, BusTrip.FIVE_STAGE));
        ...
        planner.add(new BusTrip("10N", "New Lynn", departTime, "Auckland CBD", arriveTime, BusTrip.THREE_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);
        planner.add(new BusTrip("11N", "New Lynn", departTime, "Auckland CBD", arriveTime, BusTrip.THREE_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);
        planner.add(new BusTrip("10N", "Auckland CBD", departTime, "New Lynn", arriveTime, BusTrip.FOUR_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);
        planner.add(new BusTrip("11N", "Auckland CBD", departTime, "New Lynn", arriveTime, BusTrip.FOUR_STAGE));
        
        //New Lynn to Manukau
        departTime = LocalTime.of(6, 0);
        arriveTime = LocalTime.of(6,50);
        planner.add( new BusTrip("82M", "New Lynn", departTime, "Manukau", arriveTime, BusTrip.SIX_STAGE));
        departTime = departTime.plusMinutes(60);
        arriveTime = arriveTime.plusMinutes(60);
        planner.add(new BusTrip("82M", "Manukau", departTime, "New Lynn", arriveTime, BusTrip.SIX_STAGE));
        
        //CBD to Manukau
        departTime = LocalTime.of(6,10);
        arriveTime = LocalTime.of(6,55);
        planner.add(new BusTrip("92M", "Auckland CBD", departTime, "Manukau", arriveTime, BusTrip.FIVE_STAGE));
        planner.add( new BusTrip("92M", "Manukau", departTime, "Auckland CBD", arriveTime, BusTrip.FIVE_STAGE));
        
        //PAPAKURA to Manukau
        departTime = LocalTime.of(6,15);
        arriveTime = LocalTime.of(6,45);
        planner.add(new BusTrip("88P", "Papakura", departTime, "Manukau", arriveTime, BusTrip.THREE_STAGE));
        planner.add(new BusTrip("88P", "Manukau", departTime, "Papakura", arriveTime, BusTrip.THREE_STAGE));
           
        //Kingsland to Ponsonby
        departTime = LocalTime.of(6, 0);
        arriveTime = LocalTime.of(6,15);
        planner.add(new BusTrip("10P", "Kingsland", departTime, "Ponsonby", arriveTime, BusTrip.ONE_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);
        planner.add(new BusTrip("10P", "Ponsonby", departTime, "Kingsland", arriveTime, BusTrip.ONE_STAGE));
        
         //Ponsonby to CBD
        departTime = LocalTime.of(6, 0);
        arriveTime = LocalTime.of(6,15);
        planner.add(new BusTrip("00P", "Ponsonby", departTime, "Auckland CBD", arriveTime, BusTrip.ONE_STAGE));
        planner.add(new BusTrip("00P", "Auckland CBD", departTime, "Ponsonby", arriveTime, BusTrip.ONE_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);
        planner.add(new BusTrip("02P", "Ponsonby", departTime, "Auckland CBD", arriveTime, BusTrip.TWO_STAGE));
        planner.add(new BusTrip("02P", "Auckland CBD", departTime, "Ponsonby", arriveTime, BusTrip.TWO_STAGE));
       
        //New Market to CBD
        departTime = LocalTime.of(6,10);
        arriveTime = LocalTime.of(6,25);
        planner.add(new BusTrip("53N", "New Market", departTime, "Auckland CBD", arriveTime, BusTrip.ONE_STAGE));
        planner.add(new BusTrip("53N", "New Market", departTime, "Auckland CBD", arriveTime, BusTrip.ONE_STAGE));
        departTime = departTime.plusMinutes(15);
        arriveTime = arriveTime.plusMinutes(15);
        planner.add(new BusTrip("54N", "New Market", departTime, "Auckland CBD", arriveTime, BusTrip.ONE_STAGE));
        planner.add(new BusTrip("54N", "Auckland CBD", departTime, "New Market", arriveTime, BusTrip.ONE_STAGE));
        
        //Mission Bay to CBD
        departTime = LocalTime.of(6,15);
        arriveTime = LocalTime.of(6,35);
        planner.add(new BusTrip("44B", "Auckland CBD", departTime, "Mission Bay", arriveTime, BusTrip.TWO_STAGE));
        departTime = departTime.plusMinutes(20);
        arriveTime = arriveTime.plusMinutes(20);
        planner.add(new BusTrip("44B", "Mission Bay", departTime, "Auckland CBD", arriveTime, BusTrip.TWO_STAGE));
       
        //New Market to Misssion Bay
        departTime = LocalTime.of(8,00);
        arriveTime = LocalTime.of(8,30);
        planner.add(new BusTrip("41B", "New Market", departTime, "Mission Bay", arriveTime, BusTrip.THREE_STAGE));
        departTime = departTime.plusMinutes(30);
        arriveTime = arriveTime.plusMinutes(30);
        planner.add(new BusTrip("41B", "Mission Bay", departTime, "New Market", arriveTime, BusTrip.THREE_STAGE));
      
        //Takapuna  to CBD
        departTime = LocalTime.of(7,00);
        arriveTime = LocalTime.of(7,30);
        planner.add(new BusTrip("44B", "Auckland CBD", departTime, "Takapuna", arriveTime, BusTrip.THREE_STAGE));
        departTime = departTime.plusMinutes(30);
        arriveTime = arriveTime.plusMinutes(30);
        planner.add(new BusTrip("44B", "Takapuna", departTime, "Auckland CBD", arriveTime, BusTrip.THREE_STAGE));
       
        //Takapuna  to Gulf Harbour
        departTime = LocalTime.of(7,00);
        arriveTime = LocalTime.of(8,30);
        planner.add(new BusTrip("99G", "Gulf Harbour", departTime, "Takapuna", arriveTime, BusTrip.SIX_STAGE));
        planner.add(new BusTrip("99G", "Takapuna", departTime, "Gulf Harbour", arriveTime, BusTrip.SIX_STAGE));
